...
const PLATFORMS = [
	{
		...
		name: 'photon',
		displayName: 'Photon',
		tags: ['photon', 'gen2', 'wifi', 'tcp', 'stm32f2xx']
	},
	{
		id: 8,
		name: 'p1',
		displayName: 'P1',
		tags: ['p1', 'gen2', 'wifi', 'tcp', 'stm32f2xx']
	},
	{
		id: 10,
		name: 'electron',
		displayName: 'Electron',
		tags: ['electron', 'gen2', 'cellular', 'udp', 'stm32f2xx']
	},
	{
		id: 12,
		name: 'argon',
		displayName: 'Argon',
		tags: ['argon', 'gen3', 'wifi', 'ble', 'udp', 'nrf52840']
	},
	{
		id: 13,
		name: 'boron',
		displayName: 'Boron',
		tags: ['boron', 'gen3', 'cellular', 'ble', 'udp', 'nrf52840']
	},
	// {
	// 	id: 22,
	// 	name: 'asom',
	...
	// },
	{
		...
		name: 'bsom',
		displayName: 'B SoM',
		tags: ['bsom', 'gen3', 'som', 'cellular', 'ble', 'udp', 'nrf52840']
	},
	{
		id: 25,
		name: 'b5som',
		displayName: 'B5 SoM',
		tags: ['b5som', 'gen3', 'som', 'cellular', 'ble', 'udp', 'nrf52840']
	},
	{
		id: 26,
		name: 'tracker',
		displayName: 'Tracker',
		tags: ['tracker', 'gen3', 'som', 'cellular', 'ble', 'udp', 'gps', 'nrf52840']
	},
	{
		id: 32,
		name: 'p2',
		displayName: 'P2',
		tags: ['p2', 'gen3', 'som', 'wifi', 'ble', 'udp', 'rtl872x']
	},
