...
async function applySuiteConfig(mParentSuite) {
	...
	mParentSuite.tests = [];
	// FIXME: This breaks clone()
	const harness = mParentSuite.harness;
	delete mParentSuite.harness;
	const parentHarness = mParentSuite.parent.harness;
	delete mParentSuite.parent.harness;
  ...
  dummySuite._beforeAll = [];
	...
	const parentSuite = harness.suite;
  ...
  mParentSuite.harness = harness;
  mParentSuite.parent.harness = parentHarness;
}
