 ...
 * Application name.
 */
export const APP_NAME = path.basename(PACKAGE_NAME);
...
run [--test-dir=DIR] [--device-os-dir=DIR] [--binary-dir=DIR] [--report-file=FILE] [--dry-run] [filters...]
    Run tests.
...
function parseCmdLine() {
	return parseArgs(process.argv.slice(2), {
		string: ['_', 'config-file', 'test-dir', 'binary-dir', 'device-os-dir', 'target-dir', 'report-file'],
		boolean: ['build', 'dry-run', 'fixtures', 'tags', 'combine', 'version', 'help', 'json', 'verbose'],
		alias: {
			'config-file': 'c',
			'report-file': 'r',
			'verbose': 'v',
